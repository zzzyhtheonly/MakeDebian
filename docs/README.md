# TencentOS Desktop deb软件包制作

# 工程介绍

## 背景

TencentOS Desktop基于ubuntu18.04研发，需要制作自己的软件源并定制软件包，本工程负责对tencent软件包进行定制研发，为构筑TencentOS自己的软件源进行前置的离线包制作。
...
支持将整个工程中要用到的所有源码中的所有对应关键字进行替换，如将所有ubuntu替换为tencent、 Ubuntu替换为Tencent、 tlinux替换为TencentOS等；
